...
def run_flydsl_varlen(cu, max_seqlen):
    ...
    # no per-sequence padding. Unlike flash_attn_func, it supports head_dim=192
    # natively (no pad-to-256 LDS overflow on gfx942).
    ...
    if is_rocm:
        implementations.extend(
            [
                ...
                # flash_attn_func (old kernel) is skipped at head_dim=192: padding
                # to 256 overflows gfx942's 64KB LDS. The new varlen kernel runs
                # head_dim=192 natively.
